...
touch.filter.RoadRunner.c0.PredictionSteps = 1.2
touch.filter.RoadRunner.c1.PredictionSteps = 1.8
touch.filter.RoadRunner.c2.PredictionSteps = 2.7
touch.filter.RoadRunner.c3.PredictionSteps = 3.6
touch.filter.RoadRunner.FrameRate = 0.0106
